// recuperamos el diccionario de regiones comunas desde regiones-comunas.js


// obtenemos el select de regiones en el html
let region_select = document.getElementById("region");
let comunas_select = document.getElementById("comuna");

// agregamos las regiones desde el archivo regiones-comunas.js 

// la estructura del diccionario regionesComunas es {region1: ["comuna1","comuna2"]}
// por lo que para acceder a las regiones debemos usar Object.keys(regiones_comunas)
// y para acceder a las comunas de cada region debemos usar regiones_comunas[region]
